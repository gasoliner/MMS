...
<div align="center">
    <table id="dg" title="物资种类管理" class="easyui-datagrid" style="width: 100%;height:auto"
           toolbar="#toolbar"
           fitColumns="true" singleSelect="true" pagination="true"
           data-options="rownumbers:true,
            url:'/systemDDL/list?key=kind',
            method:'get',
            pageSize:15,
            pageList:[5,10,15,20,25]">
        <thead>
        <tr>
            <th field="ddlname" width="50">物资种类</th>
            <th field="sysid" width="50">物资种类ID</th>
...
<div id="systemDDLDialog" class="easyui-dialog" style="width:500px;height:550px;padding:10px 20px"
     closed="true" buttons="#materialKindForm-buttons">
    <div class="ftitle">物资种类信息</div>
...
<div id="materialKindForm-buttons">
...
<input id="keyword" type="hidden" value="kind">
</body>
</html>
